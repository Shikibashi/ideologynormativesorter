# National, monarchic, and regional descriptive-layer guide

Date: 2026-08-11

## Scope

This pass adds curated descriptive summaries for Ethnonationalism, Absolute
Monarchism, and Regionalism. It does not change ideology scores, axes,
question prompts, result eligibility, or the existing normative and
prescriptive layers.

## Layer decisions

- **Ethnonationalism** describes the expectation that shared descent, inherited
  culture, and ethnic boundaries provide stronger national solidarity and
  continuity than voluntary civic membership. The summary is neutral about
  the definition of ethnicity while explicitly acknowledging exclusionary
  possibilities.
- **Absolute Monarchism** describes the expectation that concentrated
  hereditary sovereignty secures unity and continuity better than divided
  constitutional authority. It qualifies historical disagreement about royal
  authority, law, and the institutions through which sovereignty is exercised.
- **Regionalism** describes the expectation that regional self-rule and
  institutions closer to local identities and interests represent communities
  more responsively than centralized administration. It leaves open the
  difference between cultural protection, federal autonomy, shared rule, and
  independence.

These are descriptions of ideological expectations, not endorsements or claims
that the expected outcomes are settled empirical findings.
...
The catalog keeps Ethnonationalism distinct from civic nationalism, Absolute
Monarchism distinct from constitutional or traditional monarchism, and
Regionalism distinct from both nationalism and ecological bioregionalism.
