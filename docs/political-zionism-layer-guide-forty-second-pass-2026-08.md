# Political Zionism layer guide — forty-second pass (2026-08)

## Scope

This pass adds one descriptive-layer summary for the catalog's `zionism` label, displayed as Political Zionism. It changes consumer-facing layer copy and its test only. No centroid, axis weight, question prompt, question selection, or scoring behavior changed.

## Layer decision

Political Zionism now has a descriptive summary stating the characteristic expectation that Jewish national self-determination and a state or secure national home can protect Jewish collective survival and cultural continuity. The summary keeps the catalog's existing caveat that Zionist currents differ over state form, territory, religion, socialism, and relations with Palestinians.

This is framed as a movement-level belief, not as a claim that statehood guarantees security or cultural continuity, nor as a resolution of the competing national, historical, legal, or moral claims surrounding Israel and Palestine. The normative and prescriptive layers remain separate.
...
The focused explainer test checks that Political Zionism receives its curated descriptive copy while retaining its existing direct definition and its separate normative and prescriptive summaries.
