# Socialist strategy descriptive-layer guide

Date: 2026-08-11

## Scope

This pass adds curated descriptive summaries for Maoism, Trotskyism, and Guild
Socialism. It does not change ideology scores, axes, question prompts, result
eligibility, or the existing normative and prescriptive layers.

## Layer decisions

- **Maoism** describes revolutionary strategies that expect peasant or
  peripheral mobilization, protracted struggle, mass-line leadership, and
  opposition to bureaucratic restoration to matter especially in agrarian or
  peripheral settings. It explicitly qualifies adaptation across countries
  and periods.
- **Trotskyism** describes the expectation that socialism isolated within one
  country is vulnerable to bureaucratic degeneration and that durable
  transformation requires international or permanent revolution. It does not
  imply one contemporary Trotskyist strategy.
- **Guild Socialism** describes the expectation that capitalist industrial
  hierarchy denies workers democratic control and that public ownership with
  worker guilds can organize production through industrial democracy. It
  leaves guild autonomy, consumer interests, and state coordination open.

These are descriptions of ideological expectations and institutional theories,
not claims that the proposed arrangements have one settled empirical result.
