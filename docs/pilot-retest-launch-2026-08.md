...
This is the operational launch surface for the v5 measurement pilot. It does not replace the preregistration, privacy review, or data-management controls in [`pilot-preregistration.md`](./pilot-preregistration.md) and [`recruitment-and-retest-operations.md`](./recruitment-and-retest-operations.md).
