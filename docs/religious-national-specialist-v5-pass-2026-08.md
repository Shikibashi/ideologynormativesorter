# Religious-national specialist v5 pass

This pass versions the experimental specialist wave as
`2026-08-specialist-v5` and the context overlay as
`2026-08-question-context-v18`.

The religious-national module previously tested six general constructs but
...
account of multiple scholarly definitions of Hindutva; and Cambridge research
showing distinct socialist and other currents within Zionism. These sources
inform construct design; they do not validate a respondent identity claim.

The candidates remain experimental and are not promoted into ordinary primary
or modifier scoring. Existing assignments are deterministic, but records from
the v4 module must not be pooled with v5 module records without an explicit
cohort/linking decision.
