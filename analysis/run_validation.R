...
if (length(primary_label_roster_fingerprints) > 1 || !identical(primary_label_roster_fingerprints[[1]], required_primary_label_roster_fingerprint)) {
  stop("Expected only primary-label roster fingerprint ", required_primary_label_roster_fingerprint, "; found: ", paste(primary_label_roster_fingerprints, collapse = ", "))
}
if (length(modifier_label_roster_fingerprints) > 1 || !identical(modifier_label_roster_fingerprints[[1]], required_modifier_label_roster_fingerprint)) {
  stop("Expected only modifier-label roster fingerprint ", required_modifier_label_roster_fingerprint, "; found: ", paste(modifier_label_roster_fingerprints, collapse = ", "))
}
