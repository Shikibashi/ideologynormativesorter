...
export const CONTRIBUTION_PATH =
  "/?research=1&collection=community-2026-v3&formSize=12";
...
export function completedContributionStorage(): Record<string, string> {
  ...
  return {
    "political-judgment-research-participant-v1:community-2026-v3":
      PARTICIPANT_ID,
    "ideology-quiz-save": JSON.stringify({
      questions: form,
