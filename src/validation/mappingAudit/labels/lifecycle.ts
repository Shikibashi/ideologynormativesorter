...
export const labelLifecycleEntries: LabelLifecycleEntry[] = labels.map((label) => ({
  id: `life:${label.id}`,
  labelId: label.id,
  lifecycle: 'active',
  survivorOf: [],
...
export function lifecycleForLabel(labelId: LabelId): LabelLifecycleEntry | undefined {
