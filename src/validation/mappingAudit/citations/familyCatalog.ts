...
export const FAMILY_SCHOLARLY_CATALOG: FamilyScholarlyBundle[] = [
  ...
  },
  {
    family: "socialist",
    evidenceNote:
      "Strong SEP/IEP socialism baselines; niche labels need specialists.",
    scholarly: [
      scholarlyCite(
        "sep-socialism",
        "Socialism",
  ...
  },
  {
    ...
    evidenceNote:
      "Uses socialism SEP/IEP with reformist/welfare framing notes.",
    scholarly: [
      scholarlyCite(
  ...
  },
  {
    family: "conservative",
    evidenceNote:
      "Adequate SEP conservatism baseline; religious variants need specialists.",
    scholarly: [
      scholarlyCite(
        "sep-conservatism",
        "Conservatism",
  ...
  },
  {
    family: "anarchist",
    evidenceNote:
      "Strong SEP anarchism + socialism baselines for social-anarchist strands.",
    scholarly: [
      scholarlyCite(
        "sep-anarchism",
        "Anarchism",
  ...
  },
  {
    family: "populist",
    evidenceNote:
      "Mudde thin-ideology debate + SEP democracy for procedural context.",
    scholarly: [
      scholarlyCite(
  ...
  },
  {
    family: "democratic",
    evidenceNote:
      "Adequate generic democratic theory; confederal variants need specialists.",
    scholarly: [
      scholarlyCite(
        "sep-democracy",
        "Democracy",
  ...
  },
  {
    ...
    evidenceNote:
      "Solid SEP communitarianism baseline providing contrast with liberal individualism. Justifies tradition boundary, not quantitative placement.",
    scholarly: [
      scholarlyCite(
  ...
  },
  {
    family: "distributist",
    evidenceNote:
      "Christian-democratic / distributist intellectual history baselines.",
    scholarly: [
      scholarlyCite(
