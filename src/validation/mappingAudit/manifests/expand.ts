 ...
 */
export function expandSelectableResponses(question: Question): SelectableResponse[] {
  ...
  const values = question.responseType === 'likert5' ? LIKERT5_VALUES : LIKERT7_VALUES
...
export function contributionId(questionId: string, responseKey: string, axisId: string): string {
