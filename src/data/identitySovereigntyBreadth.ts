...
export const identitySovereigntyModuleItems: IdentitySovereigntyModuleItem[] = [
  ...
  },
  {
    question: {
      ...
      ...nationalQuestionFields,
      priorityPrompt:
        "How important is this institutional strategy to your overall outlook?",
      axisWeights: [
  ...
  },
  {
    question: {
      ...
      ...nationalQuestionFields,
      priorityPrompt:
        "How important is this institutional preference to your overall outlook?",
      axisWeights: [
  ...
  },
  {
    question: {
      ...
      ...raceQuestionFields,
      priorityPrompt:
        "How important is this community strategy to your overall outlook?",
      axisWeights: [
  ...
  },
  {
    question: {
      ...
      ...nationalQuestionFields,
      priorityPrompt:
        "How important is this constitutional preference to your overall outlook?",
  ...
  },
  {
    question: {
      ...
      ...nationalQuestionFields,
      priorityPrompt:
        "How important is this institutional route to your overall outlook?",
      axisWeights: [
  ...
  },
  {
    question: {
      ...
      ...nationalQuestionFields,
      priorityPrompt:
        "How important is this resurgence strategy to your overall outlook?",
      axisWeights: [
  ...
  },
  {
    question: {
      ...
      ...nationalQuestionFields,
      priorityPrompt:
        "How important is this transnational goal to your overall outlook?",
...
export const identitySovereigntyModuleQuestions: Question[] =
  identitySovereigntyModuleItems.map((item) => item.question);
...
export type IdentitySovereigntyAnswers = Readonly<
...
export function scoreIdentitySovereigntyConstructs(
  ...
  const scores = Object.fromEntries(
    ...
    IdentitySovereigntyConstructId,
...
export function identitySovereigntySignalDistance(
  ...
  const entries = (
    constructIds
      ? constructIds.map(
          (constructId) => [constructId, signals[constructId]] as const,
        )
      : (Object.entries(signals) as Array<
          [IdentitySovereigntyConstructId, number]
        >)
  ).filter(
    (entry): entry is [IdentitySovereigntyConstructId, number] =>
      typeof entry[1] === "number",
  );
  if (entries.length === 0) return 2;

  const meanSquared =
    entries.reduce((sum, [constructId, target]) => {
...
export function scoreIdentitySovereigntyTraditions(
  ...
  for (const tradition of identitySovereigntyTraditionProfiles) {
    const candidateEvidence = profileEvidence(
      evidence,
    ...
    if (!existing || match.distance < existing.distance)
      bestById.set(tradition.id, match);
  }
