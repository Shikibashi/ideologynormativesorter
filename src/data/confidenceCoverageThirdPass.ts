 ...
 */
export const CONFIDENCE_COVERAGE_THIRD_PASS_VERSION = '2026-08-confidence-coverage-v4'
...
const confidenceCoverageThirdPassBaseQuestions: Question[] = [
  {
    id: 'q0474',
    prompt: 'A policy can fail in practice when implementing agencies lack the staff, information, coordination, or enforcement capacity required by its design.',
  ...
  {
    id: 'q0475',
    prompt: 'Whether a government can implement a policy is better assessed by observed performance on defined tasks than by the policy’s formal existence or ambition alone.',
    domain: 'democracy-expertise-constitutionalism',
    layer: 'descriptive',
    theoryContext: 'nonideal',
    responseType: 'likert7',
  ...
  {
    id: 'q0476',
    prompt: 'Expert recommendations can gain public legitimacy when their assumptions, conflicts, uncertainty, and limits remain open to accountable political challenge.',
    domain: 'democracy-expertise-constitutionalism',
    layer: 'descriptive',
    theoryContext: 'mixed',
    responseType: 'likert7',
  ...
  {
    id: 'q0477',
    prompt: 'Delegating value-laden choices to expert bodies can weaken democratic accountability when affected people cannot meaningfully scrutinize or contest the decision.',
    domain: 'democracy-expertise-constitutionalism',
    layer: 'descriptive',
    theoryContext: 'nonideal',
    responseType: 'likert7',
  ...
  {
    id: 'q0478',
    prompt: 'Norm change is more likely to endure when new behavior becomes publicly expected and socially reinforced, not merely legally permitted.',
  ...
  {
    id: 'q0479',
    prompt: 'Changing a formal rule may leave older social expectations in place for a time when informal institutions and group sanctions continue to reward established behavior.',
    domain: 'family-gender-feminism',
    layer: 'descriptive',
    theoryContext: 'mixed',
    responseType: 'likert7',
...
export const confidenceCoverageThirdPassQuestions: Question[] = confidenceCoverageThirdPassBaseQuestions.map(stampQuestion)
