...
export const statementQuestions: Question[] = [
  ...
  },
  {
    id: "sq02",
    prompt:
      "Which comes closest to how you think about ownership of productive assets?",
  ...
  },
  {
    id: "sq03",
    prompt:
      "Which statement best matches what you believe actually happens in a modern economy?",
  ...
  },
  {
    id: "sq04",
    prompt:
      "Which best matches your read on how welfare administration tends to work in practice?",
  ...
  },
  {
    id: "sq05",
    prompt:
      "Which comes closest to your view on how to address repeat low-level offending right now?",
  ...
  },
  {
    id: "sq08",
    prompt:
      "Which statement best matches your expectations about advanced AI systems?",
  ...
  },
  {
    id: "sq09",
    prompt:
      "Which comes closest to what you'd actually do about housing costs right now?",
  ...
  },
  {
    id: "sq10",
    prompt:
      "Which best matches your view of how monetary policy actually performs?",
  ...
  },
  {
    id: "sq12",
    prompt:
      "Which comes closest to your theory of how political change actually happens?",
  ...
  },
  {
    id: "sq13",
    prompt:
      "Which claim about property and markets comes closest to your view?",
    domain: "property-ownership",
    layer: "normative",
    theoryContext: "mixed",
    responseType: "statementChoice",
  ...
  },
  {
    id: "sq14",
    prompt:
      "Which revolutionary or reform strategy seems most justified under non-ideal conditions?",
    domain: "strategy-change",
    layer: "prescriptive",
  ...
  },
  {
    id: "sq16",
    prompt:
      "Which empirical claim about ecological transition seems most plausible?",
    domain: "environment-climate-growth",
    layer: "descriptive",
    theoryContext: "mixed",
    responseType: "statementChoice",
  ...
  },
  {
    id: "sq17",
    prompt:
      "Which libertarian-leaning strategy for public goods and law is closest to yours?",
    domain: "state-legitimacy",
    layer: "prescriptive",
    theoryContext: "nonideal",
    responseType: "statementChoice",
