...
export const DESCRIPTIVE_EVIDENCE_FOURTH_PASS_VERSION = '2026-08-descriptive-evidence-v4'
...
export const descriptiveEvidenceFourthPassById: Readonly<Record<string, DescriptiveEvidence>> = {
  q0430: {
  ...
  q0444: {
    ...
    sources: [source('Social Norms', 'https://wbl.worldbank.org/en/publications/thematic-topics/social-norm', 'World Bank')],
  },
  q0445: {
...
export function applyDescriptiveEvidenceFourthPass(question: Question): Question {
