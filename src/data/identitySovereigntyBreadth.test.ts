...
const ARCHETYPES: Archetype[] = [
  {
    ...
    answers: {
      'fm-id-1': 3, 'fm-id-2': -3, 'fm-id-3': 3, 'fm-id-4': -3,
      'fm-id-5': -2, 'fm-id-6': 2, 'fm-id-7': 0, 'fm-id-8': 1,
      'fm-id-9': 0, 'fm-id-10': 0, 'fm-id-11': 0, 'fm-id-12': 0,
      'fm-id-13': 0, 'fm-id-14': 0, 'fm-id-15': 0, 'fm-id-16': 0,
  ...
  },
  {
    ...
    answers: {
      'fm-id-1': -2, 'fm-id-2': 3, 'fm-id-3': -3, 'fm-id-4': 3,
      'fm-id-5': 3, 'fm-id-6': -3, 'fm-id-7': 2, 'fm-id-8': -2,
      'fm-id-9': 0, 'fm-id-10': 0, 'fm-id-11': 0, 'fm-id-12': 1,
      'fm-id-13': 0, 'fm-id-14': 1, 'fm-id-15': 1, 'fm-id-16': 0,
      'fm-id-17': 0, 'fm-id-18': 0,
    },
  },
  {
    ...
    answers: {
      'fm-id-1': 0, 'fm-id-2': 1, 'fm-id-3': -1, 'fm-id-4': 2,
      'fm-id-5': 2, 'fm-id-6': -2, 'fm-id-7': 2, 'fm-id-8': -2,
      'fm-id-9': 3, 'fm-id-10': 3, 'fm-id-11': -2, 'fm-id-12': 2,
      'fm-id-13': 0, 'fm-id-14': 0, 'fm-id-15': 0, 'fm-id-16': 0,
      'fm-id-17': 1, 'fm-id-18': 1,
    },
  },
  {
    ...
    answers: {
      'fm-id-1': 0, 'fm-id-2': 0, 'fm-id-3': -1, 'fm-id-4': 1,
      'fm-id-5': 1, 'fm-id-6': -1, 'fm-id-7': 3, 'fm-id-8': -3,
      'fm-id-9': 3, 'fm-id-10': 1, 'fm-id-11': 3, 'fm-id-12': -3,
      'fm-id-13': 0, 'fm-id-14': 0, 'fm-id-15': 0, 'fm-id-16': 0,
      'fm-id-17': 1, 'fm-id-18': 0,
    },
  },
  {
    ...
    answers: {
      'fm-id-1': 0, 'fm-id-2': 1, 'fm-id-3': -2, 'fm-id-4': 2,
  ...
  },
  {
    ...
    answers: {
      'fm-id-1': 0, 'fm-id-2': 0, 'fm-id-3': -2, 'fm-id-4': 2,
      'fm-id-5': 1, 'fm-id-6': -1, 'fm-id-7': 3, 'fm-id-8': -3,
  ...
  },
  {
    ...
    answers: {
      'fm-id-1': 0, 'fm-id-2': 1, 'fm-id-3': -1, 'fm-id-4': 1,
      'fm-id-5': 1, 'fm-id-6': -1, 'fm-id-7': 0, 'fm-id-8': 0,
      'fm-id-9': 1, 'fm-id-10': 2, 'fm-id-11': -1, 'fm-id-12': 1,
      'fm-id-13': 0, 'fm-id-14': 0, 'fm-id-15': 0, 'fm-id-16': 0,
      'fm-id-17': 3, 'fm-id-18': 3,
    },
  },
]

const profileById = (id: string) => identitySovereigntyTraditionProfiles.filter((profile) => profile.id === id)
...
describe('identity and sovereignty breadth module', () => {
  it('keeps the specialist measurement surface isolated and well formed', () => {
    ...
    for (const item of identitySovereigntyModuleItems) {
      ...
      expect(['national-identity-sovereignty', 'race-ethnicity-multiculturalism']).toContain(
  ...
  it('measures each local construct with at least two items', () => {
    for (const constructId of IDENTITY_SOVEREIGNTY_CONSTRUCT_IDS) {
      ...
      expect(coverage, `${constructId} has insufficient specialist coverage`).toBeGreaterThanOrEqual(2)
    }
  })
  ...
  it('models variants without multiplying catalog labels', () => {
    expect(profileById('black-nationalism').map((profile) => profile.variant).sort()).toEqual([
      'community nationalism',
      'separatist nationalism',
    ])
    expect(profileById('indigenism').map((profile) => profile.variant).sort()).toEqual([
      'institutional self-government',
      'resurgence and refusal',
    ])
  })
  ...
  it('allows Black community nationalism and Pan-Africanism to co-occur', () => {
    const community = ARCHETYPES.find((archetype) => archetype.id === 'black-community-nationalist')
    ...
    const blackNationalism = matches.find((match) => match.id === 'black-nationalism')
    const panAfricanism = matches.find((match) => match.id === 'pan-africanism')
    const ethnonationalism = matches.find((match) => match.id === 'ethnonationalist')
