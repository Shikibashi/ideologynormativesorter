 ...
 */
export const fifteenthPassRewritesById: Readonly<Record<string, FifteenthPassRewrite>> = {
  q0033: {
    prompt: 'An ideal property regime should distinguish personal possessions from ownership or control of productive assets.',
    rationale: 'Replace a four-part bundle about possessions, productive assets, land rents, and state-created privileges with one property-regime distinction that respondents can evaluate without taking a position on every adjacent policy instrument.',
  ...
  q0036: {
    prompt: 'Legal systems should make it easier for workers to form and govern worker-owned cooperatives.',
    rationale: 'Replace a bundle of cooperatives, small firms, mutual aid, and independent work with the specific institutional model supported by the cited cooperative research: worker-owned and worker-governed firms.',
  ...
  q0193: {
    prompt: 'An ideal justice system should use incapacitation only when necessary to prevent serious harm.',
    rationale: 'Separate incapacitation from restitution and prevention so agreement measures a single coercive threshold rather than three different aims of legal justice.',
  ...
  q0354: {
    prompt: 'Expert agencies should give affected people transparent reasons for consequential decisions and a meaningful way to appeal them.',
    rationale: 'Replace four heterogeneous safeguards—transparency, appeal, sunset review, and competitive alternatives—with a coherent accountability construct centered on reasons and challenge rights for affected people.',
  ...
  q0375: {
    prompt: 'Government access to private data should require case-specific authorization under clear legal rules.',
    rationale: 'Replace a bundle of warrants, minimization, and adversarial oversight with one authorization principle that can be evaluated across different data-access regimes without presupposing one procedural form.',
  ...
  q0376: {
    prompt: 'People affected by a consequential public algorithm should be able to inspect an audit of its use and challenge the resulting decision.',
    rationale: 'Replace the three-domain bundle about benefits, policing, and immigration with one cross-domain contestability construct while retaining the two safeguards that define it: auditability and a route to challenge a decision.',
