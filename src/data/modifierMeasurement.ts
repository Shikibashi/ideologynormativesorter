...
export const modifierMeasurementDefinitions = [
  coreConstruct(
    ...
    [
      ...
      indicator('q0322', 'Rejects prestige-, empire-, or crusade-driven use of a state population.'),
      indicator('q0323', 'Distinguishes defense from regime transformation abroad.'),
      indicator('q0326', 'Separates solidarity with oppressed people from military control over them.'),
    ],
  ),
  catalogOnly(
    'civic-nationalist',
  ...
  coreConstruct(
    ...
    [
      indicator('q0201', 'Rejects birthplace as a morally sufficient basis for excluding peaceful people from ordinary opportunity.'),
      indicator('q0321', 'Treats foreign civilians as no less morally important because of political borders.'),
      indicator('q0233', 'Permits local, regional, national, and cosmopolitan affiliations to coexist.'),
    ],
  ),
  coreConstruct(
    ...
    [
      indicator('q0161', 'Tests protection for dissenting and unpopular expression.'),
      indicator('q0164', 'Tests privacy as a condition for dissent and minority life.'),
      indicator('q0173', 'Tests a default rights regime across speech, encryption, association, religion, and due process.'),
    ],
  ),
  coreConstruct(
    ...
    [
      indicator('q0015', 'Tests dispersing reform authority across independently accountable institutions.'),
      indicator('q0018', 'Tests divided rather than unitary executive control of enforcement agencies.'),
      indicator('q0053', 'Tests decentralized experimentation instead of one mandatory production plan.'),
    ],
  ),
  catalogOnly(
  ...
  coreConstruct(
    ...
    [
      ...
      indicator('q0264', 'Tests whether formal family consent is adequate under blocked exit, violence, or dependency.'),
      indicator('q0421', 'Tests structural gender and sexual hierarchy beyond formal equal rights.'),
    ],
  ),
  catalogOnly(
  ...
  coreConstruct(
    ...
    [
      indicator('q0281', 'Tests rejection of inherited group status as a basis for legal standing and opportunity.'),
      indicator('q0282', 'Tests equal citizenship without making cultural uniformity a condition.'),
      indicator('q0293', 'Tests equal individual rights alongside voluntary cultural association.'),
    ],
  ),
  catalogOnly(
    'regionalism',
  ...
  coreConstruct(
    ...
    [
      indicator('q0458', 'Tests whether checkable methods and reported uncertainty improve expert advice.'),
      indicator('q0460', 'Tests whether independent technical expertise can improve public decisions when openly contestable.'),
      indicator('q0476', 'Tests accountable challenge, transparency, and limits around expert recommendations.'),
    ],
  ),
  catalogOnly(
    'nationalism',
...
export const modifierMeasurementByLabelId = new Map<LabelId, ModifierMeasurementDefinition>(
  modifierMeasurementDefinitions.map((definition) => [definition.labelId, definition]),
)

export function modifierMeasurementForLabel(labelId: LabelId): ModifierMeasurementDefinition | undefined {
