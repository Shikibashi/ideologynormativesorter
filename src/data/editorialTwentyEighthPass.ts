...
export const precisionRewritesById: Readonly<Record<string, PrecisionRewrite>> =
  {
    q0081: {
      ...
      rationale:
        "The previous item bundled organizing, refusal, bargaining, exit, rival-firm formation, and legal favoritism. The revised wording isolates freedom of association and collective bargaining, which are closely related labor-rights constructs with direct ILO framing; refusal, exit, competitive entry, and property rules remain separate questions.",
    },
    q0411: {
      prompt:
      ...
      rationale:
        "The previous item combined workplace governance, neighborhood councils, territorial federation, and transition strategy. The revised wording isolates the proposed worker-council governance of production; neighborhood administration and transition sequencing remain distinct institutional and strategic questions.",
    },
  };
