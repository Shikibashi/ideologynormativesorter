 ...
 */
export const DESCRIPTIVE_EVIDENCE_FIFTH_PASS_VERSION =
  "2026-08-descriptive-evidence-v5";
...
export const descriptiveEvidenceFifthPassById: Readonly<
  Record<string, QuestionSource>
> = {
  q0007: source(
...
export function applyDescriptiveEvidenceFifthPass(
  question: Question,
): Question {
