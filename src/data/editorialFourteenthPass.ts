 ...
 */
export const fourteenthPassRewritesById: Readonly<Record<string, FourteenthPassRewrite>> = {
  q0147: {
    prompt: 'In some digital markets, open and interoperable standards can reduce switching or integration barriers.',
    rationale: 'Replace the broad innovation and shared-knowledge claim with the narrower interoperability mechanism supported by OECD evidence. The item no longer treats lower barriers as a universal innovation or competition result.',
  ...
  q0248: {
    prompt: 'In countries with an official or preferred religion, governments are more likely to restrict other religious groups than in countries without one.',
    rationale: 'Replace the unsupported mechanism about every doctrinal disagreement becoming enforceable law with the cross-national comparison actually measured by Pew: official or preferred religion, legal or practical preference, and restrictions on other religious groups.',
  ...
  q0307: {
    prompt: 'Under CERCLA/Superfund, identifying a liable party can trigger a cleanup obligation or recovery of cleanup costs.',
    rationale: 'Replace the general causal claim that liability reduces pollution harm with the documented legal mechanism: identifying a potentially responsible party can support cleanup or cost recovery under the named U.S. regime.',
  ...
  q0368: {
    prompt: 'In GAO’s review of DHS law-enforcement technologies, agencies reported using many detection, observation, and monitoring tools in public spaces, while technology policies did not always address key privacy protections.',
    rationale: 'Name the DHS and GAO scope and replace the unsupported general-purpose claim with the report’s measured findings about technology use and policy coverage.',
