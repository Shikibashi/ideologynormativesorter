 ...
 */
export const twentySecondPassRewritesById: Readonly<Record<string, TwentySecondPassRewrite>> = {
  q0114: {
    prompt: 'Where housing supply is constrained, policy should remove barriers to apartments, accessory units, and mixed-use construction before broadly subsidizing demand.',
    rationale: 'Condition the sequencing preference on constrained supply and name the housing forms at issue. The original wording treated supply reform as universally prior even though construction capacity, subsidy targeting, infrastructure, and local market conditions affect the result.',
  ...
  q0123: {
    prompt: 'Saving, lending, and payment services should generally be open to new providers, subject to proportionate safeguards for capital, disclosure, consumer protection, and payment integrity.',
    rationale: 'Replace the vague “unless specific risks are shown” exception with the distinct safeguards that make entry compatible with financial stability and consumer protection. Saving, lending, and payment services are related but do not carry identical risk profiles.',
  ...
  q0142: {
    prompt: 'Creators should ordinarily receive attribution, but legal control over downstream uses should be limited when it would unnecessarily restrict criticism, research, repair, or follow-on creation.',
    rationale: 'Separate attribution from exclusive downstream control and replace the absolute “all downstream uses” phrase with recognizable cases where copyright limitations or exceptions may matter. The item does not deny compensation, licensing, or other creator-support mechanisms.',
  ...
  q0154: {
    prompt: 'Patent policy should narrow patent exclusivity—through shorter terms, narrower claims, or broader exceptions—before expanding enforcement remedies.',
    rationale: 'Define “scope” as claims and exceptions and distinguish the breadth of exclusivity from enforcement remedies. The original item bundled several patent-policy levers without naming what each lever changes.',
  ...
  q0158: {
    prompt: 'Information policy should favor interoperable, open protocols and licensing that preserves follow-on use over broad exclusionary enforcement.',
    rationale: 'Make “open protocols” and “voluntary licensing” operational by tying them to interoperability and follow-on use, and replace the undefined “monopoly enforcement” with broad exclusionary enforcement. These are related but distinct competition and intellectual-property choices.',
  ...
  q0217: {
    prompt: 'Interior immigration enforcement should prioritize serious violence and fraud over otherwise nonviolent violations of immigration status or work authorization, with due process protections.',
    rationale: 'Replace “ordinary work or residence” with the legally clearer distinction between serious criminal conduct and otherwise nonviolent status or work-authorization violations, while making procedural protection explicit. Enforcement priorities and offense classifications vary by jurisdiction and policy.',
