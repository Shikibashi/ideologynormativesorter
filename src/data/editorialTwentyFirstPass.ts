 ...
 * change.
 */
export const twentyFirstPassRewritesById: Readonly<Record<string, TwentyFirstPassRewrite>> = {
  q0135: {
    prompt: 'Bank-resolution rules should protect insured depositors while allocating losses to shareholders and unsecured or uninsured creditors before public funds.',
    rationale: 'Replace the inaccurate “currency holders” category and the unsupported claim about managers with the claims hierarchy used in international resolution standards. Management accountability can be a separate governance question; deposit insurance and public solvency support are distinct safeguards.',
  ...
  q0136: {
    prompt: 'People should generally be free to hold and use private, foreign, or digital currencies, subject to rules addressing fraud, insolvency, consumer protection, and payment-system stability.',
    rationale: 'Keep the alternative-currency preference while naming the regulatory boundary that the original item omitted. Private money, foreign currency, commodity-linked instruments, and digital assets do not have identical legal-tender, redemption, or systemic-risk properties.',
  ...
  q0318: {
    prompt: 'Climate policy should prioritize reducing carbon and material intensity through technology and efficiency rather than broad consumption limits.',
    rationale: 'Remove the undefined “abundance” and motive-imputing “austerity imposed by bureaucracy.” The revised item compares two recognizable policy strategies while leaving empirical questions about absolute decoupling, rebound, distribution, and sufficiency open.',
