...
export const sixteenthPassRewritesById: Readonly<
  Record<string, SixteenthPassRewrite>
> = {
  q0355: {
    prompt:
      "Referendum proposals should be reviewable for compatibility with fundamental rights before the vote.",
    rationale:
      "Replace a three-part bundle about fiscal notes, rights constraints, and anti-minority targeting with one pre-vote rights-compatibility review construct supported by comparative referendum standards.",
    evidenceNote:
      "Scope to pre-vote review of referendum proposals for compatibility with fundamental rights. Fiscal notes, question clarity, campaign fairness, and rules against targeting minorities are related but distinct safeguards; agreement with this item does not specify one review body or imply that fiscal analysis is unnecessary.",
