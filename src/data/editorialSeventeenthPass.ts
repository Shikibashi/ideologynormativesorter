 ...
 */
export const seventeenthPassRewritesById: Readonly<Record<string, SeventeenthPassRewrite>> = {
  q0012: {
    prompt: 'In documented common-pool and polycentric settings, durable cooperation has relied on predictable rules, monitoring, graduated sanctions, and accessible conflict resolution.',
    rationale: 'Scope the broad order claim to the institutional settings and mechanisms documented by Ostrom rather than treating polycentric governance as a universal substitute for sovereignty.',
  ...
  q0027: {
    prompt: 'In documented land-tenure systems, clear possession, transfer, and dispute-resolution rules can reduce overlapping claims while also distributing access and bargaining power.',
    rationale: 'Remove the unsupported “artificial scarcity” condition and make the item cover both the conflict-reduction mechanism and the institutional distributional tradeoff.',
    evidenceNote: 'Scope to land and resource-tenure systems: compare overlapping claims and disputes under different rules for possession, transfer, and resolution, while separately recording how those rules distribute scarcity, access, and bargaining power.',
    sourceIds: ['property', 'landTenure'],
  },
  q0030: {
    prompt: 'In state-owned enterprises, public ownership changes the governance chain but does not by itself remove managerial hierarchy or accountability problems.',
    rationale: 'Replace the stronger claim that ownership “often transfers control” with the source-supported distinction between ownership and governance structure.',
  ...
  q0047: {
    prompt: 'In market exchanges, prices can transmit some dispersed information without any participant knowing the whole economy, although market power and externalities can limit that function.',
    rationale: 'Add the mechanism’s scope and principal qualifications so the Hayekian information claim is not read as a complete defense of markets.',
  ...
  q0048: {
    prompt: 'Centralized planners may lack access to changing, local, or tacit information even when they are honest and technically competent.',
    rationale: 'Replace rhetorical character traits with the specific information-access problem supported by the cited economic literature.',
  ...
  q0148: {
    prompt: 'In patent-intensive sectors, portfolios may be used for commercialization, licensing, cross-licensing, litigation strategy, or defense as well as for protecting inventions.',
    rationale: 'Remove the unsupported comparison that strategic use displaces useful disclosure and distinguish portfolio strategy from the patent system’s disclosure function.',
  ...
  q0171: {
    prompt: 'Emergency-law frameworks use sunset clauses, renewal limits, and periodic review because exceptional powers can persist beyond the conditions that prompted them.',
    rationale: 'Replace the broad panic-and-law causal story with the narrower institutional persistence risk directly reflected in emergency-law safeguards.',
  ...
  q0188: {
    prompt: 'Law-enforcement performance systems distinguish activity measures such as arrests and response times from outcomes such as safety, trust, and perceived legitimacy.',
    rationale: 'Turn the relative-ease claim into a source-supported distinction between activity and outcome measures without implying that every department ignores safety.',
  ...
  q0190: {
    prompt: 'When law-enforcement agencies can receive or spend forfeiture proceeds, the funding structure creates a potential resource incentive around seizures.',
    rationale: 'Make the incentive claim conditional and institutional rather than asserting that forfeiture necessarily turns property into revenue in every case.',
  ...
  q0269: {
    prompt: 'Tax-transfer and benefit rules can produce different eligibility and net-transfer outcomes for households classified by marriage, children, cohabitation, or other characteristics.',
    rationale: 'Replace the metaphor of administrative invisibility with the measurable classification and transfer differences documented in household-typology research.',
  ...
  q0308: {
    prompt: 'Command-and-control environmental rules can distribute compliance burdens unevenly across firms, industries, and facilities, so effects on incumbents and entrants must be measured.',
    rationale: 'Replace the unsupported directional claim that these rules often favor large incumbents with the empirically testable incidence question supported by EPA cost studies.',
    evidenceNote: 'Scope to the distribution of compliance burdens by firm size, industry, facility age, and design under a named command-and-control rule. Evidence can show pressure on smaller or newer entrants or other uneven effects, but the direction and magnitude must be measured rather than assumed from the policy label.',
    sourceIds: ['environmentalComplianceCosts'],
  },
  q0348: {
    prompt: 'In low-salience elections or policy domains, information acquisition can be limited by the small expected effect of an individual vote and by issue salience.',
    rationale: 'Scope the rational-ignorance mechanism to low-salience settings and avoid claiming that voters generally lack information or incentives.',
