 ...
 */
export const twentiethPassRewritesById: Readonly<Record<string, TwentiethPassRewrite>> = {
  q0007: {
    prompt: 'In U.S. metropolitan police-service comparisons, more autonomous service providers were not associated with lower efficiency and were sometimes associated with higher efficiency.',
    rationale: 'Use an associational formulation and name the service domain. Ostrom’s work compares metropolitan police arrangements; it does not establish that autonomous provision improves every public service or that exit creates a competitive market for all government functions.',
  ...
  q0067: {
    prompt: 'In a U.S. SNAP study, later recertification interview assignments reduced successful recertification and subsequent participation among affected cases.',
    rationale: 'Name the program and study design, and distinguish the measured administrative margin from a universal claim about all welfare programs or all ineligible cases. The study found large short-run recertification effects and smaller later participation effects, with substantial re-enrollment.',
  ...
  q0107: {
    prompt: 'In high-cost metropolitan housing markets, permitting additional construction can moderate price pressure when land-use rules constrain supply.',
    rationale: 'Replace the vague and normatively loaded outcome “reduce exclusion” with the housing-price mechanism actually examined by the cited zoning research. Access, displacement, density, and distributional effects remain separate questions.',
  ...
  q0328: {
    prompt: 'In the Afghanistan reconstruction, outside planners often struggled to adapt projects to local political and institutional conditions.',
    rationale: 'Reduce a three-part claim about political, security, and institutional knowledge to the adaptation problem documented in the Afghanistan reconstruction record. The item no longer generalizes from one case to military interventions as a class.',
  ...
  q0402: {
    prompt: 'A country may legitimately use force in anticipatory self-defense when an armed attack is sufficiently imminent.',
    rationale: 'Remove “overwhelming force” and the unbounded phrase “before threats materialize.” The revised item isolates the contested normative question of anticipatory self-defense; it does not merge imminence with proportionality or preventive war against a remote future threat.',
