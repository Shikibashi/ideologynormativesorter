...
const AUTHORITATIVE_RELATIONS: readonly RelationSeed[] = [
  ...
  seed(
    ...
    "conceptual",
    "property-legitimacy",
    "Agorism is a strategic-organizational subtype of market anarchism in the approved Specialist family graph.",
    "subtype-acyclic",
  ),
  seed(
    "anarcho-primitivism",
    ...
    "conceptual",
    "ecology.intrinsic-standing",
    "Anarcho-primitivism and deep ecology overlap in anti-industrial and ecological-order concerns while remaining distinct traditions.",
    "symmetric-overlap",
  ),
  seed(
    "anarcho-communist",
    ...
    "conceptual",
    "property-legitimacy",
    "Anarcho-communism is a narrower communal and anti-state branch within libertarian socialism.",
    "subtype-acyclic",
  ),
  seed(
    "democratic-confederalism",
    ...
    "institutional",
    "centralization-preference",
    "Democratic confederalism institutionalizes decentralist commitments through communes, councils, and confederation.",
    "institutional-form-not-identity",
  ),
  seed(
    "democratic-confederalism",
    ...
    "institutional",
    "centralization-preference",
    "Democratic confederalism institutionalizes regional and confederal coordination without becoming identical to regionalism.",
    "institutional-form-not-identity",
  ),
  seed(
    "geolibertarian",
    ...
    "conceptual",
    "property-legitimacy",
    "Geolibertarianism combines Georgist rent claims with a right-libertarian property and exchange host.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "geolibertarian",
    ...
    "conceptual",
    "property-legitimacy",
    "Geolibertarianism combines a right-libertarian host with a distinct natural-rent boundary.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "individualist-anarchism",
    ...
    "historical",
    "property-legitimacy",
    "Individualist anarchism has an approved influence relation to mutualist traditions without subtype inheritance.",
    "influence-not-subtype",
  ),
  seed(
    "individualist-anarchism",
    ...
    "conceptual",
    "authority-legitimacy",
    "Individualist anarchism overlaps with Egoist Anarchism/Stirnerism while retaining a broader field.",
    "symmetric-overlap",
  ),
  seed(
    "left-wing-market-anarchism",
    ...
    "conceptual",
    "property-legitimacy",
    "Left-wing market anarchism combines market-anarchist coordination with a distinct anti-capitalist privilege analysis.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "libertarian-municipalism",
    ...
    "institutional",
    "centralization-preference",
    "Libertarian municipalism institutionalizes decentralist commitments through direct-democratic municipalities and confederation.",
    "institutional-form-not-identity",
  ),
  seed(
    "market-anarchism",
    ...
    "conceptual",
    "property-legitimacy",
    "Market anarchism overlaps with anarcho-capitalism while leaving property and anti-capitalist boundaries internally plural.",
    "symmetric-overlap",
  ),
  seed(
    "mutualist",
    ...
    "conceptual",
    "property-legitimacy",
    "Mutualism overlaps with individualist anarchism while retaining distinct reciprocity, possession, and mutual-credit commitments.",
    "symmetric-overlap",
  ),
  seed(
    "mutualist",
    ...
    "conceptual",
    "property-legitimacy",
    "Mutualism overlaps with social anarchism while retaining distinct reciprocity, possession, and mutual-credit commitments.",
    "symmetric-overlap",
  ),
  seed(
    "queer-anarchism",
    ...
    "conceptual",
    "centralization-preference",
    "Queer anarchism combines social-anarchist anti-domination with a direct critique of enforced sexual and gender conformity.",
    "hybrid-host-remains-interpretable",
  ),
  seed(
    "queer-anarchism",
    ...
    "conceptual",
    "equality.formal-status",
    "Queer anarchism combines queer norm critique with anti-hierarchical strategy.",
    "hybrid-host-remains-interpretable",
  ),
  seed(
    "voluntaryism",
    ...
    "conceptual",
    "authority-legitimacy",
    "Voluntaryism overlaps with minarchism over voluntariness and bounded state claims without resolving the state question identically.",
    "symmetric-overlap",
  ),
  seed(
    "council-communist",
    ...
    "conceptual",
    "centralization-preference",
    "Council communism is a strategic-organizational subtype within libertarian socialism.",
    "subtype-acyclic",
  ),
  seed(
    "maoism",
    ...
    "historical",
    "reform-vs-revolution",
    "Maoism is historically influenced by Marxism-Leninism without becoming a generic synonym for it.",
    "influence-not-subtype",
  ),
  seed(
    "syndicalist",
    ...
    "conceptual",
    "centralization-preference",
    "Syndicalist currents overlap with anarcho-syndicalism while retaining a broader strategic field.",
    "symmetric-overlap",
  ),
  seed(
    "syndicalist",
    ...
    "conceptual",
    "centralization-preference",
    "Syndicalist currents overlap with libertarian socialism without making every syndicalist current anarchist.",
    "symmetric-overlap",
  ),
  seed(
    "trotskyism",
    ...
    "historical",
    "reform-vs-revolution",
    "Trotskyism is historically influenced by Marxism-Leninism while retaining an anti-Stalinist and permanent-revolution boundary.",
    "influence-not-subtype",
  ),
  seed(
    "bioregionalism",
    ...
    "conceptual",
    "ecology.intrinsic-standing",
    "Bioregionalism combines Green Politics with an ecological-region and institutional-scale commitment.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "bioregionalism",
    ...
    "conceptual",
    "political-community-boundary",
    "Bioregionalism combines regional organization with ecological place and institutional redesign.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "deep-ecology",
    ...
    "conceptual",
    "ecology.intrinsic-standing",
    "Deep ecology is an ecological/moral subtype within Green Politics.",
    "subtype-acyclic",
  ),
  seed(
    "degrowth-green",
    ...
    "conceptual",
    "ecology.intrinsic-standing",
    "Degrowth Green is a post-growth economic subtype within Green Politics.",
    "subtype-acyclic",
  ),
  seed(
    "ecomodernist",
    ...
    "conceptual",
    "ecology.intrinsic-standing",
    "Ecomodernism is a technology and institutional variant within Green Politics.",
    "subtype-acyclic",
  ),
  seed(
    "eco-fascism",
    ...
    "conceptual",
    "political-community-boundary",
    "Eco-fascism combines fascist-authoritarian power with ecological and national exclusion; neither host is reducible to the other.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "ecosocialist",
    ...
    "conceptual",
    "ecology.intrinsic-standing",
    "Ecosocialism combines Green Politics with democratic social ownership and ecological limits.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "ecosocialist",
    ...
    "conceptual",
    "property-legitimacy",
    "Ecosocialism combines democratic socialism with an ecological standing and limits commitment.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "green-capitalism",
    ...
    "conceptual",
    "ecology.intrinsic-standing",
    "Green capitalism combines Green Politics with market-compatible ecological transition.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "neoconservative",
    ...
    "historical",
    "authority-legitimacy",
    "Neoconservatism is a historical strategic variant within the Conservative family, with an external-order bridge.",
    "subtype-acyclic",
  ),
  seed(
    ...
    "historical",
    "political-community-boundary",
    "One-Nation Conservatism is a historical-regional conservative variant with paternalist cohesion and gradual reform.",
    "subtype-acyclic",
  ),
  seed(
    "paleoconservatism",
    ...
    "historical",
    "political-community-boundary",
    "Paleoconservatism is a historical-regional conservative variant with a scope-specific national and localist morphology.",
    "subtype-acyclic",
  ),
  seed(
    "paleolibertarianism",
    ...
    "conceptual",
    "property-legitimacy",
    "Paleolibertarianism combines a right-libertarian host with a distinct traditional social-order commitment.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "black-feminism",
    ...
    "conceptual",
    "equality.formal-status",
    "Black feminism combines Feminist Orientation with an identity-situated analysis of race, class, sexuality, and power.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "queer-politics",
    ...
    "conceptual",
    "equality.formal-status",
    "Queer Politics overlaps with Feminist Orientation while retaining a distinct critique of sexual and gender norms.",
    "symmetric-overlap",
  ),
  seed(
    "queer-politics",
    ...
    "conceptual",
    "centralization-preference",
    "Queer Politics overlaps with Queer Anarchism while not requiring an anti-state strategy.",
    "symmetric-overlap",
  ),
  seed(
    "socialist-feminism",
    ...
    "conceptual",
    "equality.formal-status",
    "Socialist feminism combines Feminist Orientation with a class, property, labor, and social-reproduction analysis.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "socialist-feminism",
    ...
    "conceptual",
    "property-legitimacy",
    "The approved Marxian/Socialist analysis phrase is represented by the canonical Marxian Socialism host without promoting the Specialist to that role.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "kemalism",
    ...
    "historical",
    "political-community-boundary",
    "Kemalism combines civic-nationalist membership with a distinct historical state-building program.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "religious-nationalism",
    ...
    "conceptual",
    "political-community-boundary",
    "Religious nationalism combines National Orientation with a distinct religious identity and public-authority configuration.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    "agrarian-populism",
    ...
    "conceptual",
    "political-community-boundary",
    "Agrarian populism combines a Populist Frame with a distinct agrarian producer-class and organizational morphology.",
    "hybrid-requires-distinct-facet",
  ),
  seed(
    ...
    "conceptual",
    "political-community-boundary",
    "Confucian political revival overlaps with Communitarianism while retaining distinct hierarchy, merit, and civilizational claims.",
    "symmetric-overlap",
  ),
  seed(
    "strasserism",
    ...
    "historical",
    "authority-legitimacy",
    "Strasserism is a historically situated subtype within Fascist Authoritarianism.",
    "subtype-acyclic",
  ),
  seed(
    "technocratic-centralist",
    ...
    "conceptual",
    "expert-confidence",
    "Technocratic centralism combines Technocratic Orientation with a distinct concentrated-authority project.",
    "hybrid-requires-distinct-facet",
  ),
];
