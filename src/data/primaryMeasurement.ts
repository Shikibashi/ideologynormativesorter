...
export const primaryScoringScopeByLabelId = {
   'market-liberal': coreScope(
      ['authority-legitimacy', 'property-legitimacy', 'liberty-noninterference', 'market-process-confidence'],
      ['authority-legitimacy', 'property-legitimacy', 'liberty-noninterference', 'market-process-confidence'],
   ...
   'social-democrat': coreScope(
      ['property-legitimacy', 'equality-theory', 'state-action-vs-exit', 'reform-vs-revolution'],
   ...
   'christian-democrat': coreScope(
      ['property-legitimacy', 'equality-theory', 'centralization-preference', 'secularism-religious'],
      ['property-legitimacy', 'equality-theory', 'centralization-preference', 'secularism-religious'],
   ...
   'marxist-leninist': coreScope(
      ['authority-legitimacy', 'property-legitimacy', 'market-process-confidence', 'centralization-preference', 'reform-vs-revolution', 'state-action-vs-exit'],
      ['authority-legitimacy', 'property-legitimacy', 'centralization-preference', 'reform-vs-revolution', 'state-action-vs-exit'],
   ...
   'libertarian-socialism': coreScope(
      ['authority-legitimacy', 'property-legitimacy', 'equality-theory', 'anti-domination', 'centralization-preference'],
      ['authority-legitimacy', 'property-legitimacy', 'equality-theory', 'anti-domination'],
   ...
   'radical-democracy': coreScope(
      ['authority-legitimacy', 'equality-theory', 'anti-domination', 'centralization-preference'],
   ...
   'national-conservatism': coreScope(
      ['political-community-boundary', 'moral-traditionalism', 'cultural-plasticity'],
   ...
   'liberal-conservatism': coreScope(
      ['property-legitimacy', 'liberty-noninterference', 'market-process-confidence', 'cultural-plasticity', 'gradualism-vs-immediatism'],
      ['property-legitimacy', 'liberty-noninterference', 'market-process-confidence', 'cultural-plasticity'],
   ...
   conservative: coreScope(
      ['cultural-plasticity', 'reform-vs-revolution', 'gradualism-vs-immediatism'],
...
export function attachPrimaryScoringScope<T extends IdeologyLabel>(label: T): T {
   const scoringScope = primaryScoringScopeByLabelId[
