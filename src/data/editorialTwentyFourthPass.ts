...
export const boundaryRewritesById: Readonly<Record<string, BoundaryRewrite>> = {
  q0405: {
    prompt: 'Religious tradition may legitimately inform public law even when some citizens do not share it.',
    rationale: 'Replace “shared religious heritage” with the more precise claim about religious tradition informing coercive law; heritage, doctrinal authority, and public-law legitimacy are related but not identical constructs.',
  },
  q0415: {
    prompt: 'A nation’s political membership should be defined by shared citizenship and institutions rather than ancestry.',
    rationale: 'Remove the compound comparison between civic, ethnic, and religious identity. The item now measures civic membership versus ancestry, while the neighboring religion-and-law items cover the separate religious-authority construct.',
    axisWeights: [
