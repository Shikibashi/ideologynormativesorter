...
export const feministModuleItems: FeministModuleItem[] = [
  ...
  },
  {
    question: {
      ...
      layer: 'prescriptive',
      ...commonQuestionFields,
      priorityPrompt: 'How important is this organizational question to your overall outlook?',
      axisWeights: [
...
export type FeministModuleAnswers = Readonly<Record<string, number | undefined>>

export function scoreFeministConstructs(answers: FeministModuleAnswers): Record<FeministConstructId, number> {
  const scores = Object.fromEntries(
    FEMINIST_CONSTRUCT_IDS.map((constructId) => [constructId, { numerator: 0, denominator: 0 }]),
