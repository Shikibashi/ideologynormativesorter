  ...
  [
    {
      ...
      measurementCaution:
        "Black Nationalism is currently displayed only as community-autonomy or separatist self-determination orientations; Pan-African output is limited to solidarity and unity. Neither is a validated identity diagnosis.",
      nextGate:
        "Validate focused-module reliability and role separation with respondent data before promoting candidate traditions or changing multiculturalism’s modifier role.",
    },
    {
    ...
    },
    {
      ...
      measurementCaution:
        "Green profiles may be multi-affinity: ecological concern, growth skepticism, technology confidence, and governance preferences are intentionally not forced into one scale.",
      nextGate:
        "Test multi-affinity scoring, construct independence, criterion interpretation, and stability before promoting ecological subtypes or treating a high fit as a singular green identity.",
    },
    {
      ...
      measurementCaution:
        "The module separates ownership and strategy rather than treating socialism as one party, state, or economic mechanism.",
      nextGate:
        "Assess construct reliability, differentiation from the broad socialist anchors, and fairness across respondents before promoting any socialist variant into ordinary scoring.",
    },
    {
      ...
      measurementCaution:
        "Conservative variants share a family name but can diverge over social norms, nation, markets, democracy, welfare, and foreign policy; the module is not a generic conservatism detector.",
      nextGate:
        "Validate separation among prudential, social, national, Christian-democratic, liberal-conservative, and neoconservative dimensions before changing public primary roles.",
    },
    {
      ...
      nextGate:
        "Pool respondent data from the v10 construct-matched module, test separation of Islamic democratic constitutionalism, broad Political Islam, and the two-item final-religious-legal-authority comparison, and keep all current labels provisional until those tests pass.",
      measurementCaution:
        "The Theocratic Politics comparison is a direct but narrow experimental affinity: it requires a two-item direct measure of final religious authority over civil-law legitimacy, not private faith, establishment, national identity, one religion, or an empirically validated respondent identity.",
    },
    {
      ...
      nextGate:
        "Pool respondent data from the v10 module and test whether the direct religious-national fusion construct, Hindu civilizational belonging, Jewish national self-determination, and religious-national variants separate reliably before adding subtypes or interpreting a single centroid as precise.",
    },
    {
      ...
      measurementCaution:
        "These labels remain browsable and sourced, but ordinary axes such as authority, nationalism, religiosity, redistribution, or ecological concern are not substitutes for their defining constructs. They must not be returned as ordinary results until a dedicated follow-up measures those constructs and is empirically evaluated.",
      nextGate:
        "Design separate expert-reviewed items for each defining construct, complete cognitive interviewing and false-positive review, then assign a versioned opt-in module before enabling any respondent-facing specialist match.",
    },
    {
      ...
      nextGate:
        "Pool respondent data from the v5 technology-governance module and test the separation of accelerationist direction, cyberocratic authority, and techno-anarchist infrastructure preferences before splitting or promoting emerging labels.",
    },
    {
      ...
      measurementCaution:
        "This family crosses regime type and decentralized governance; a municipal or confederal preference is not itself a monarchist commitment.",
      nextGate:
        "Validate regime-type and decentralization constructs separately, including respondents who combine constitutional monarchy with local autonomy or confederal governance.",
    },
  ];
