...
export const LEGACY_LABEL_COMPOSITIONS: Readonly<Record<string, readonly LabelId[]>> = {
   'civil-libertarian-cosmopolitan': ['civil-libertarianism', 'cosmopolitanism'],
   'decentralist-market-skeptic-of-state': ['market-liberal', 'decentralist-orientation'],
...
export const LEGACY_LABEL_DISPOSITIONS = {
   'conservative-liberalism': {
      ...
      rationale: 'The two public names are semantic mirrors in this catalog, so the older ID resolves to the single canonical combined entry.',
   },
   'bright-green-environmentalism': {
      disposition: 'alias',
      components: ['ecomodernist'],
      rationale: 'The former public wording is retained as a historical name for the canonical Ecomodernist entry.',
   },
   'civil-libertarian-cosmopolitan': {
      disposition: 'split',
      components: ['civil-libertarianism', 'cosmopolitanism'],
      rationale: 'Civil-libertarian and cosmopolitan commitments can vary independently, so the former conjunction expands into two modifiers.',
   },
   'decentralist-market-skeptic-of-state': {
      disposition: 'split',
      components: ['market-liberal', 'decentralist-orientation'],
      rationale: 'The former profile combined a market-oriented family with a separable institutional preference for decentralization.',
   },
   'national-traditionalist': {
      disposition: 'split',
      components: ['national-conservatism', 'social-conservatism'],
      rationale: 'The former profile joined national-conservative and social-conservative commitments; religious-national commitments remain contingent rather than assumed.',
   },
   'cultural-populism': {
      disposition: 'keep-retired',
      rationale: 'Its cultural content can be conservative, progressive, multicultural, nationalist, or otherwise; no fixed active component set preserves that historical ambiguity.',
   },
   'egalitarian-statist': {
      disposition: 'keep-retired',
      rationale: 'The synthetic combination of egalitarian outcomes and state capacity does not map deterministically onto one active political family or technocratic orientation.',
   },
   'revolutionary-collectivist': {
      disposition: 'keep-retired',
      rationale: 'Revolutionary strategy and collectivist ownership appear across distinct socialist traditions; collapsing the legacy profile into one would create a false historical identity.',
   },
} as const satisfies Readonly<Record<(typeof RETIRED_LABEL_IDS)[number], LegacyLabelDispositionMetadata>>
...
const ROLE_RATIONALES: Readonly<Partial<Record<LabelId, string>>> = {
   ...
   'market-right-libertarianism': 'Broad right-libertarian family anchor; market anarchism, mutualism, and anarcho-capitalism remain distinct anarchist or contested specialist traditions.',
   'market-liberal': 'Broad contemporary pro-market liberal family anchor; it accepts an enabling state and limited safety net and is distinct from both neoliberalism and right-libertarianism.',
   mutualist: 'Plural anarchist tradition with Proudhonian, American individualist, and later revivalist interpretations; Proudhon influenced part of the Tuckerite field, while reciprocal exchange and federation overlap with social and market anarchisms without making it a required subtype of either.',
   ...
   ethnonationalist: 'Cross-cutting account of national membership and political boundary; it can combine with multiple broader ideologies and is measured through the identity-sovereignty layer rather than treated as a complete primary program.',
   'market-anarchism': 'Anarchist market-order family anchor; property, reciprocity, counter-economics, and capitalist versus non-capitalist variants require specialist discrimination.',
   'third-way': 'Historically bounded social-democratic modernization current retained for browsing and future depth measurement rather than ordinary primary scoring.',
   baathism: 'Historically consequential Arab-nationalist and socialist synthesis retained as a provisional regional specialist; doctrine and later party-state practice must remain distinct.',
   'developmental-authoritarianism': 'State-led developmental and authoritarian synthesis retained as a provisional specialist; developmentalism also appears in democratic and non-authoritarian forms.',
   'civil-libertarian-cosmopolitan': 'Cross-cutting combination of strong civil liberties and universalist or transnational concern; it does not determine property, welfare, or world-government preferences.',
   'technocratic-centralist': 'Narrow compound profile requiring both expert-centered authority and centralized administration; neither evidence-informed policy nor administrative capacity alone establishes it.',
   'fascist-authoritarian': 'Historically specific palingenetic-ultranationalist project retained as a provisional specialist because the core bank does not directly measure national-rebirth myth or fascist mobilization.',
   'welfare-chauvinism': 'Access-boundary position retained as a provisional specialist because generic nationalism and redistribution axes do not directly measure exclusion from welfare or social services.',
   'religious-nationalism': 'Cross-cutting fusion of religious and national identity retained for the construct-matched opt-in module; generic religiosity and nationalism alone are insufficient.',
   theocrat: 'Political-order specialist retained for the construct-matched opt-in module because the core bank cannot establish final religious legal authority from broad religiosity, social traditionalism, or religious public participation.',
   'eco-authoritarianism': 'Ecological-authority synthesis retained as a provisional specialist because the core bank does not directly measure willingness to override democratic or rights constraints specifically for ecological enforcement.',
   ...
   nationalism: 'Base national-orientation modifier; membership rules, territorial projects, and host ideology are measured separately.',
   populism: 'Thin people-versus-elite and popular-sovereignty modifier; substantive left/right content comes from host ideology and other modifiers.',
   'civil-libertarianism': 'Cross-cutting rights orientation concerning speech, privacy, association, due process, protest, religion, and bodily autonomy, independent of economic ideology.',
   cosmopolitanism: 'Cross-cutting orientation toward equal moral concern across borders; it is distinct from international cooperation and world federalism.',
   'decentralist-orientation': 'Cross-cutting preference for local, federal, municipal, polycentric, or voluntary institutions over concentrated territorial authority.',
   'feminist-orientation': 'Cross-cutting concern with gendered power, exclusion, care, reproduction, violence, labor, or representation without selecting one feminist school.',
   'economic-nationalism': 'Cross-cutting preference for national productive capacity, strategic autonomy, domestic industry, managed trade, or control of key assets.',
   transhumanism: 'Cross-cutting orientation toward deliberate technological enhancement; it leaves economic, democratic, and distributive commitments open.',
   'confucian-political-revival': 'Modern Confucian political family with democratic, constitutional, perfectionist, and meritocratic branches; it is not synonymous with Asian Values or authoritarianism.',
}
...
const RELATIONS_BY_ID: Readonly<Partial<Record<LabelId, readonly LabelRelation[]>>> = {
   'social-anarchism': [
      { type: 'subtype_of', labelId: 'libertarian-socialism' },
      { type: 'contrasts_with', labelId: 'marxist-leninist', note: 'Both may seek social ownership, but they diverge over party-state authority and centralized transition.' },
   ],
   'market-anarchism': [
      { type: 'overlaps_with', labelId: 'mutualist' },
      { type: 'overlaps_with', labelId: 'anarcho-capitalist', note: 'Both reject the state and value non-state market coordination, but anarcho-capitalism makes strong private-property commitments that market anarchism as a family does not settle.' },
      { type: 'often_combines_with', labelId: 'individualist-anarchism' },
      { type: 'contrasts_with', labelId: 'anarcho-communist' },
   ],
   mutualist: [
      { type: 'overlaps_with', labelId: 'individualist-anarchism', note: 'Proudhon influenced portions of the Tuckerite American individualist-anarchist field, including Joseph (Jo) and Laurance Labadie. That field also includes natural-rights and egoist currents, so the relation is neither identity nor two exhaustive mutualist camps.' },
      { type: 'overlaps_with', labelId: 'social-anarchism', note: 'Mutualist federation and anti-domination can overlap with social or communal anarchism, but mutualism does not inherit that branch’s full economic program.' },
      { type: 'overlaps_with', labelId: 'market-anarchism', note: 'Mutualist and market-anarchist currents can share anti-statism and exchange, while differing over property, exploitation, rent, and the meaning of a freed market.' },
      { type: 'often_combines_with', labelId: 'left-wing-market-anarchism', note: 'Some contemporary writers connect mutualist anti-privilege arguments to left-wing market anarchism, but neither label is a subtype of the other.' },
   ],
   'individualist-anarchism': [
      { type: 'influenced_by', labelId: 'mutualist', note: 'Proudhonian mutualism influenced portions of the Tuckerite American individualist tradition, including figures linked to Joseph (Jo) and Laurance Labadie; later revivalist work is not treated as a historical parent, and the broader individualist field is not reducible to mutualism.' },
   ],
   'anarcho-capitalist': [
      { type: 'overlaps_with', labelId: 'market-anarchism', note: 'A contested market-anarchist relative: it shares anti-statism and market coordination but adds a distinctive private-property account.' },
      { type: 'overlaps_with', labelId: 'market-right-libertarianism', note: 'Shares the right-libertarian property and contract tradition, while rejecting the minimal state that some right-libertarians retain.' },
   ],
   'market-right-libertarianism': [
      { type: 'overlaps_with', labelId: 'anarcho-capitalist', note: 'Anarcho-capitalism is a stateless right-libertarian variant, but the broad family also includes minimal-state positions.' },
   ],
   georgism: [
   ...
   'market-socialist': [
      ...
      { type: 'contrasts_with', labelId: 'marxist-leninist', note: 'Market socialism does not by itself specify a Leninist party-state.' },
   ],
   'marxian-socialism': [
      { type: 'contrasts_with', labelId: 'marxist-leninist', note: 'The non-Leninist anchor shares Marxian analysis but does not make vanguard-party organization or centralized transitional state power a defining commitment.' },
   ],
   'marxist-leninist': [
      { type: 'contrasts_with', labelId: 'marxian-socialism', note: 'Marxism-Leninism combines Marxian analysis with a distinctive theory of revolutionary party organization and state power; it is not a subtype of the non-Leninist anchor.' },
   ],
   'black-nationalism': [
   ...
   'developmental-authoritarianism': [
      ...
      { type: 'incompatible_with_core', labelId: 'radical-democracy', note: 'This is a derived context profile, not a standalone ideology.' },
   ],
   'technocratic-centralist': [
      { type: 'requires', labelId: 'technocratic-orientation', note: 'Technocratic centralism adds concentrated administrative authority to a broader confidence in expert governance; expert advice alone is insufficient.' },
   ],
   baathism: [
...
function measurementStatusForRole(labelId: LabelId, role: LabelRole): LabelMeasurementStatus {
  if (role === 'primary') return 'core-primary'
  if (role === 'modifier') {
    const measurement = modifierMeasurementForLabel(labelId)
    if (!measurement) {
      throw new Error(`Modifier ${labelId} is missing a direct-measurement disposition`)
    }
    if (measurement.availability === 'core-construct') return 'modifier-scored'
    if (measurement.availability === 'focused-follow-up') return 'modifier-follow-up'
...
export function normalizeHistoricalLabelIds(labelIds: readonly LabelId[]): LabelId[] {
   return [...new Set(labelIds.flatMap((labelId) => {
...
const CANONICAL_NAME_OVERRIDES: Readonly<Record<string, string>> = {
  ...
  'developmental-authoritarianism': 'Developmental Authoritarianism (Derived Context)',
...
export const modifierScoringLabels = labels
  .filter((label) => labelTaxonomyById.get(label.id)?.measurementStatus === 'modifier-scored')
  .map(canonicalizeLabel)
