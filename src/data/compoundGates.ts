...
export const compoundGates: readonly CompoundGate[] = [
  {
    ...
    rationale:
      "Fascism requires more than generic authority or nationalism: the ordinary gate requires anti-liberal, exclusionary, centralized, and coercive commitments to be measured together.",
  },
  {
    ...
    rationale:
      "Marxism-Leninism requires a socialist property commitment together with vanguard-style centralization and revolutionary state transition; generic egalitarianism is insufficient.",
  },
  {
    ...
    rationale:
      "Welfare chauvinism requires both bounded membership and support for redistributive provision; either nationalism or welfare support alone must not produce it.",
  },
  {
    ...
    rationale:
      "Religious nationalism requires a national boundary commitment and a public role for religious identity; religiosity or nationalism in isolation is not enough.",
  },
  {
    ...
    rationale:
      "Eco-authoritarianism requires ecological priority and concentrated, less-pluralist enforcement together; climate concern or state capacity alone is insufficient.",
  },
  {
    ...
    rationale:
      "The historical Nazi construct requires racial-exclusionary hierarchy and totalizing centralized coercion in addition to generic authoritarian or interventionist views.",
  },
  {
    ...
    rationale:
      "Christian Reconstructionism requires a theonomic religious-public-order commitment, not generic Christianity, conservatism, or family traditionalism.",
  },
  {
    ...
    rationale:
      "Georgist libertarianism requires both strong individual liberty and a predistributive property-reform orientation; generic market support does not identify its land-rent boundary.",
  },
  {
    ...
    rationale:
      "Anarcho-capitalism requires both anti-state authority and strong private-property commitments; right-libertarian or market views alone do not establish anarcho-capitalism.",
  },
  {
    ...
    rationale:
      "Anarcho-communism requires anti-state authority together with communal or egalitarian property commitments; anti-authoritarianism alone is not enough.",
  },
  {
    labelId: "maoism",
    allOf: [
    ...
    rationale:
      "Maoism requires revolutionary socialist transformation and centralized transition; egalitarianism or state intervention by themselves do not identify the tradition.",
  },
  {
    ...
    rationale:
      "National Bolshevism is a conjunction of strong national priority and authoritarian socialist or state-centered commitments, not a synonym for nationalism or socialism alone.",
  },
  {
    labelId: "strasserism",
    allOf: [
    ...
    rationale:
      "Strasserism requires a fascist-ultranationalist and coercive core; anti-capitalist rhetoric alone must not generate it.",
  },
];
