...
describe('question context overlay', () => {
  it('versions and covers every active core and specialist question', () => {
    ...
    expect(new Set(contextTargets.map((question) => question.id)).size).toBe(406)
  ...
  it('keeps explicit high-risk records resolvable', () => {
   ...
   it('has bespoke records for every active core question', () => {
      for (const question of activeCoreQuestions) {
         expect(questionContextById[question.id], `${question.id} needs a bespoke record`).toBeDefined()
         expect(questionContextById[question.id]?.sourceIds?.length, `${question.id} needs matched sources`).toBeGreaterThan(0)
      }
   })
   ...
   it('gives every active statement-choice item bespoke construct boundaries', () => {
      ...
      const activeStatementQuestions = statementQuestions.filter((question) =>
         activeCoreQuestions.some((activeQuestion) => activeQuestion.id === question.id),
      )
      expect(activeStatementQuestions).toHaveLength(Object.keys(expectedSources).length)
      for (const question of activeStatementQuestions) {
         ...
         expect(record?.contextNote?.length, `${question.id} context is too short`).toBeGreaterThan(100)
   ...
   it('uses claim-matched records for conditional cross-domain empirical items', () => {
      const expectedSources: Record<string, string[]> = {
         ...
         q0076: ['snapRecertification', 'householdTypologies', 'distributiveJustice'],
         q0077: ['polycentricGovernance', 'distributiveJustice', 'snapRecertification'],
         ...
         q0085: ['occupationalLicensingEntry', 'labourRights', 'employmentRelationship'],
         ...
         q0116: ['housingSupplyAffordability', 'housingSupply', 'housingDemandSubsidies'],
         q0117: ['landTenure', 'property', 'housingSupply'],
         q0119: ['housingSupplyAffordability', 'housingSupply', 'distributiveJustice'],
         q0121: ['monetaryPolicy', 'privateMoneyPayments', 'liberalism'],
         q0122: ['monetaryPolicy', 'privateMoneyPayments', 'distributiveJustice'],
         q0123: ['financialEntryBarriers', 'financialEntryLicensing', 'paymentSystemIntegrity'],
         ...
         q0158: ['openStandardsDigitalInnovation', 'openStandardsCompetition', 'copyrightLimitations'],
         ...
         'fm-rn-5': ['islamicConstitutionalism', 'democracy', 'civilPoliticalRights'],
         'fm-rn-6': ['islamicPartyCompetition', 'democracy', 'civilPoliticalRights'],
         'fm-rn-7': ['cambridgeIslamicConstitutionalism2023', 'islamicConstitutionalism', 'civilPoliticalRights'],
         'fm-rn-8': ['islamicDemocracy', 'islamicPartyCompetition', 'democracy', 'civilPoliticalRights'],
         'fm-rn-9': ['oxfordHindutvaDefinitions', 'ethnonationalism', 'civilPoliticalRights'],
         'fm-rn-10': ['cambridgeZionismHistory', 'cambridgeZionismLabour', 'nationalism'],
         ...
         q0315: ['climateAssessment', 'regulatoryInformationAsymmetry', 'environmentalComplianceCosts'],
         q0316: ['environmentalEthics', 'climateAssessment', 'environmentalComplianceCosts'],
         q0317: ['climateAssessment', 'policyCapture', 'regulatorGovernance'],
         q0319: ['climateAssessment', 'environmentalEthics', 'civilPoliticalRights'],
         ...
         q0363: ['aiEthics', 'civilPoliticalRights', 'decentralizedNetworkGovernance'],
         ...
         q0377: ['openStandardsCompetition', 'competitionAssessment', 'decentralizedNetworkGovernance'],
         ...
         q0394: ['politicalReform', 'civilDisobedience', 'democraticConfederalism'],
         ...
         q0058: ['marketsKnowledge', 'polycentricGovernance', 'regulatoryInformationAsymmetry'],
         q0059: ['markets', 'property', 'civilPoliticalRights'],
         q0141: ['intellectualProperty', 'copyrightLimitations'],
         q0144: ['copyrightLimitations', 'openStandardsCompetition', 'intellectualProperty'],
         q0145: ['patentExceptions', 'intellectualProperty'],
         q0146: ['intellectualProperty', 'copyrightLimitations', 'civilPoliticalRights'],
         q0153: ['copyrightLimitations', 'intellectualProperty'],
         q0155: ['copyrightLimitations', 'openStandardsCompetition', 'intellectualProperty'],
         q0156: ['intellectualProperty', 'openStandardsDigitalInnovation'],
         q0157: ['copyrightLimitations', 'intellectualProperty'],
         q0159: ['copyrightLimitations', 'intellectualProperty', 'civilPoliticalRights'],
         ...
         q0283: ['multiculturalism', 'civilPoliticalRights', 'distributiveJustice'],
         ...
         q0407: ['employeeGovernance', 'structuralDomination', 'property', 'socialism'],
         ...
         'fm-fem-3': ['feministPolitics', 'feministEthics', 'civilPoliticalRights'],
         ...
         'fm-id-4': ['civilPoliticalRights', 'multiculturalism', 'ethnonationalism'],
         ...
         'fm-gr-2': ['climateDecoupling', 'climateAssessment', 'distributiveJustice'],
         'fm-gr-3': ['climateDecoupling', 'environmentalComplianceCosts', 'policyCapture'],
         'fm-gr-4': ['environmentalEthics', 'democraticConfederalism', 'democracy'],
         ...
         'fm-rn-1': ['cambridgeIslamicConstitutionalism2023', 'islamicConstitutionalism', 'democracy'],
         'fm-rn-2': ['theocracySecularism', 'secularism', 'civilPoliticalRights'],
         'fm-rn-3': ['nationalism', 'secularism', 'religionOfficialStatus'],
         'fm-rn-4': ['civilPoliticalRights', 'multiculturalism', 'religionOfficialStatus'],
         ...
         'fm-mm-3': ['federalism', 'democraticConfederalism', 'polycentricGovernance'],
      }
