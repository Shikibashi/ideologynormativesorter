...
export const DESCRIPTIVE_EVIDENCE_THIRD_PASS_VERSION = '2026-08-descriptive-evidence-v3'
...
export const descriptiveEvidenceThirdPassById: Readonly<Record<string, DescriptiveEvidence>> = {
  q0347: {
...
export function applyDescriptiveEvidenceThirdPass(question: Question): Question {
