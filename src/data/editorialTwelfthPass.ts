 ...
 */
export const twelfthPassRewritesById: Readonly<Record<string, TwelfthPassRewrite>> = {
  q0207: {
    prompt: 'In randomized intergroup-contact studies with outcomes measured at least one day later, most comparisons reported lower measured prejudice, but effect sizes varied by target group and evidence for durable reductions in adults’ racial or ethnic prejudice was limited.',
    rationale: 'Keep the review’s qualified positive average while specifying random assignment and delayed outcomes; remove the unsupported implication that religious and immigrant targets uniformly showed weaker effects and surface the review’s adult racial/ethnic evidence gap.',
