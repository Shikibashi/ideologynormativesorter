...
export const experimentalSpecialistModuleSpecs: readonly ExperimentalSpecialistModuleSpec[] = [
   spec(
      ...
      [
         candidate('social-anarchism', 'Social / Communal Anarchism', 'A family-level experimental affinity for anti-authoritarian, communal, and federated social organization. It does not make mutualism, market anarchism, syndicalism, anarcho-communism, or a single transition strategy a required subtype.', { 'anti-authority': 0.9, 'market-coordination': -0.25, 'communal-property': 0.7, 'direct-federation': 0.8 }, [gate('anti-authority', 0.6), gate('communal-property', 0.35), gate('direct-federation', 0.55)]),
