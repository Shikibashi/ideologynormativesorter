...
export const axes: Axis[] = [
   ...
   },
   {
      ...
      layer: 'normative',
      name: 'Militarism vs Pacifism',
      negativePole: 'Military force is rarely if ever legitimate',
      positivePole: 'Military force is a normal tool of statecraft',
      description: 'Whether the use of military force and war is treated as a legitimate instrument of policy or as a last resort to be avoided.',
   },
   {
